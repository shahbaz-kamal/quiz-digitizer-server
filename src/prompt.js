const geminiContents = [
    {
      ...
      **Question :**
      For each distinct question , extract the following details. Don't extract any handwritten text, markings, or calculations. Focus solely on printed content and that appears to be a question
        ...
        "questions": [
          {
            ...
            "main_question_text": "string | null", // The common text/stem for questions with multiple sub-parts (e.g., "The diagram below shows..."). it's a single question then that question text will be provided.
